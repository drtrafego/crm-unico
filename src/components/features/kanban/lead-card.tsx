...
function GoogleAdsIcon({ className }: { className?: string }) {
  // Logo oficial do Google Ads — triângulo com ponto verde
  return (
    <svg viewBox="0 0 24 24" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M3.2 22.4c1.8 1.1 4.1.5 5.2-1.3L16.1 7.5c-1.8-1.1-4.1-.5-5.2 1.3L3.2 22.4z" fill="#FBBC04"/>
      <path d="M16.1 7.5l-7.7 13.6c1.1 1.8 3.4 2.4 5.2 1.3l7.7-13.6c-1.1-1.8-3.4-2.4-5.2-1.3z" fill="#4285F4"/>
      <circle cx="5.4" cy="19.5" r="3.2" fill="#34A853"/>
    </svg>
  );
}

function MetaIcon({ className }: { className?: string }) {
  // Logo oficial da Meta — infinito azul
  return (
    <svg viewBox="0 0 512 256" className={className} xmlns="http://www.w3.org/2000/svg">
      <path fill="#0081FB" d="M128 32c-44.8 0-76.8 26.4-97.6 69.6C11.2 138.4 0 182.4 0 212.8c0 46.4 25.6 91.2 73.6 91.2 27.2 0 48-15.2 68.8-42.4 14.4-19.2 28.8-44 40.8-67.2l8-16c19.2-36.8 42.4-78.4 73.6-108C282.4 53.6 310.4 32 368 32c48 0 83.2 24 105.6 62.4C496 128 512 172.8 512 212.8c0 43.2-10.4 84.8-32.8 117.6-22.4 32.8-57.6 57.6-105.6 57.6-32.8 0-59.2-11.2-81.6-29.6l-27.2 44.8c29.6 21.6 64.8 34.4 108.8 34.4 65.6 0 115.2-33.6 143.2-75.2 28-42.4 40.8-94.4 40.8-150.4 0-51.2-11.2-104-38.4-147.2C496 22.4 448 0 368 0c-46.4 0-82.4 19.2-110.4 47.2-24.8 24.8-44 56.8-61.6 89.6l-8 16c-12.8 24-25.6 46.4-38.4 64-15.2 19.2-27.2 28.8-40.8 28.8-20 0-32-17.6-32-44.8 0-26.4 11.2-64 29.6-98.4 16-30.4 28.8-45.6 48.8-45.6l1.6 0c16 0 28.8 8 43.2 21.6l30.4-44.8C202.4 10.4 168 0 128 0z"/>
    </svg>
  );
}
