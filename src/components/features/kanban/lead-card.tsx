          ...
          >
            <Card
              className={cn(
                ...
                snapshot.isDragging && "shadow-2xl ring-2 ring-indigo-500/50 bg-white dark:bg-slate-900 !opacity-100 border-indigo-400/50 shadow-indigo-500/40 rotate-2 scale-[1.02] transition-none"
              )}
              onClick={() => {
